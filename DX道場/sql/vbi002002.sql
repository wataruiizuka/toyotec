DROP TABLE IF EXISTS gold.vbi002002;
CREATE TABLE gold.vbi002002 AS
SELECT
    v2001.zone_name_abbreviation AS エリア統括部と店舗
    , 'ゾーン名称' AS 区分名称
    , '1' AS 区分コード
...
FROM
    dx_ve.vbi002001_en v2001
LEFT JOIN dx_ve.vbi002004_en v2004
