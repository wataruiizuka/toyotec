-- Run second: populate Gold tables with INSERT OVERWRITE
...
-- INSERT OVERWRITE preserves the original DROP + CTAS replacement behavior.
...
INSERT OVERWRITE TABLE gold.vbi000008
select
	--販社コード
 	t001g.cd_hansya as `販社コード`,
 	--会社コード
...
INSERT OVERWRITE TABLE gold.vbi000010
select
	--販社コード
	t001g.cd_hansya as `販社コード`,
 	--会社コード
...
INSERT OVERWRITE TABLE gold.vbi000012
select
	--ソート順
...
INSERT OVERWRITE TABLE gold.VBI001003
SELECT
	--販社コード
	cd_hansya AS 販社コード,
	--会社コード
...
INSERT OVERWRITE TABLE gold.vbi002001_en
--販社コードがTMTの店舗
SELECT
...
INSERT OVERWRITE TABLE gold.VBI002003
SELECT
    months.month AS 月, --月
...
INSERT OVERWRITE TABLE gold.vbi002002
SELECT
...
INSERT OVERWRITE TABLE gold.vbi002007
SELECT
...
INSERT OVERWRITE TABLE gold.VBI002008
SELECT
...
INSERT OVERWRITE TABLE gold.vbi0020012
SELECT
    tbg7005m_3.cd_hansya AS 販社コード, --販社コード
    tbg7005m_3.cd_kaisya AS 会社コード, --会社コード
    tbg7005m_3.cd_tenpo AS 店舗コード, --店舗コード
...
INSERT OVERWRITE TABLE gold.vbi0020013
SELECT
    tbg7005m_3.cd_hansya AS 販社コード, --販社コード
    tbg7005m_3.cd_kaisya AS 会社コード, --会社コード
    tbg7005m_3.cd_tenpo AS 店舗コード, --店舗コード
...
INSERT OVERWRITE TABLE gold.vbi0020014
SELECT
    tbg7005m_3.cd_hansya AS 販社コード, --販社コード
    tbg7005m_3.cd_kaisya AS 会社コード, --会社コード
    tbg7005m_3.cd_tenpo AS 店舗コード, --店舗コード
...
INSERT OVERWRITE TABLE gold.VBI006001
select 
...
INSERT OVERWRITE TABLE gold.VBI010001
SELECT  
...
INSERT OVERWRITE TABLE gold.VBI010002
SELECT  
	t201m.cd_hansya AS 販社コード, --販社コード
	t201m.cd_kaisya AS 会社コード, --会社コード
	t201m.cd_tenpo AS 店舗コード, --店舗コード
...
INSERT OVERWRITE TABLE gold.VBI010003
SELECT  
	t201m.cd_hansya AS 販社コード, --販社コード
	t201m.cd_kaisya AS 会社コード,  --会社コード
	t201m.cd_tenpo AS 店舗コード,  --店舗コード
...
INSERT OVERWRITE TABLE gold.VBI010006
SELECT  
...
INSERT OVERWRITE TABLE gold.VBI016002
SELECT
...
INSERT OVERWRITE TABLE gold.VBI016004
SELECT
	販社コード, --販社コード
	会社コード, --会社コード
	新車車名, --新車車名
...
INSERT OVERWRITE TABLE gold.VBI016005
SELECT
	販社コード, --販社コード
	会社コード, --会社コード
	新車車名, --新車車名
...
INSERT OVERWRITE TABLE gold.VBI016006
SELECT
	販社コード, --販社コード
	会社コード, --会社コード
...
INSERT OVERWRITE TABLE gold.VBI016007
SELECT
	販社コード, -- 販社コード
	会社コード, -- 会社コード
	ゾーン名称, -- ゾーン名称
...
INSERT OVERWRITE TABLE gold.VBI016008
SELECT
	販社コード, -- 販社コード
	会社コード, -- 会社コード
	店舗コード, -- 店舗コード
...
INSERT OVERWRITE TABLE gold.VBI016009
SELECT
	販社コード, -- 販社コード
	会社コード, -- 会社コード
	店舗コード, -- 店舗コード
...
INSERT OVERWRITE TABLE gold.VBI016010
SELECT
	t201m.cd_hansya AS 販社コード, -- 販社コード
	t201m.cd_kaisya AS 会社コード, -- 会社コード
	t201m.cd_tenpo AS 店舗コード, -- 店舗コード
...
INSERT OVERWRITE TABLE gold.VBI016011
SELECT
		t201m.cd_hansya AS 販社コード, -- 販社コード
		t201m.cd_kaisya AS 会社コード, -- 会社コード
		t201m.cd_tenpo AS 店舗コード, -- 店舗コード
...
INSERT OVERWRITE TABLE gold.vbi017003
SELECT 
	--販社コード
...
INSERT OVERWRITE TABLE gold.enoreport_full_fixed_work_date
SELECT
    t.cd_hansya,
    t.cd_kaisya,
    TO_TIMESTAMP(
...
INSERT OVERWRITE TABLE gold.vbi019002
SELECT 
	--販社コード
	cd_hansya,
	--会社コード
...
INSERT OVERWRITE TABLE gold.VBI022004
SELECT
	--販社コード
	cd_hansya AS 販社コード,
	--会社コード
...
INSERT OVERWRITE TABLE gold.vbi999002
SELECT
...
INSERT OVERWRITE TABLE gold.vbi999003
SELECT
	1 AS `No.`, --No
	t200m.cd_hansya AS `販社コード`, --販社コード
	t200m.cd_kaisya AS `会社コード`, --会社コード
...
INSERT OVERWRITE TABLE gold.vbi999004
SELECT
...
INSERT OVERWRITE TABLE gold.vbi999005
SELECT
...
INSERT OVERWRITE TABLE gold.vbi013002
SELECT
...
INSERT OVERWRITE TABLE gold.vbi013003
WITH months AS (
  SELECT 1 AS month
  UNION ALL
  SELECT 2 AS month
...
INSERT OVERWRITE TABLE gold.vbi013007
WITH table_8014m AS (SELECT
    ROW_NUMBER() OVER(ORDER BY 1) AS logic_pk,
    tbg8014m.*
...
INSERT OVERWRITE TABLE gold.vbi013011
WITH kb_genkin_table AS(
    SELECT
        tbi999013m.cd_hansya
        , tbi999013m.cd_kaisya
...
INSERT OVERWRITE TABLE gold.vbi013012
SELECT
...
INSERT OVERWRITE TABLE gold.vbi013013
SELECT
  tbg7005m_3.cd_hansya AS `販社コード`
  , tbg7005m_3.cd_kaisya AS `会社コード`
  , tbg7005m_3.cd_tenpo AS `店舗コード`
...
INSERT OVERWRITE TABLE gold.vbi013014
SELECT
  tbg7005m_3.cd_hansya AS `販社コード`
  , tbg7005m_3.cd_kaisya AS `会社コード`
  , tbg7005m_3.cd_tenpo AS `店舗コード`
...
INSERT OVERWRITE TABLE gold.vbi013015
WITH alert_text AS (
